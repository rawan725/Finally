...
<main class="flex-grow flex items-center justify-center p-6 bg-[radial-gradient(circle_at_top_right,_#e0eee0_0%,_#f0f4f2_100%)]">
    ...
    <div class="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 login-card rounded-[40px] overflow-hidden shadow-[0px_32px_64px_-16px_rgba(27,67,50,0.16)]">

        <!-- Content Section -->
        <div class="lg:col-span-7 p-8 md:p-14 lg:p-20 flex flex-col justify-center">

            <div class="mb-12 text-right">
                <h2 class="font-display-md text-primary mb-3">
                    أهلاً بك مرة أخرى
                </h2>

                <p class="font-body-md text-on-surface-variant/80">
                    أدخل بياناتك لتتمكن من الوصول لخدماتنا المميزة
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="space-y-2.5 text-right">
                    ...
                    <div class="relative group">
                        ...
                        <span class="material-symbols-outlined absolute left-5 top-1/2 -translate-y-1/2 text-outline group-focus-within:text-secondary transition-colors pointer-events-none">
                            mail
                        </span>

                        <input
                            class="login-input w-full pr-6 pl-14 py-4 rounded-2xl shadow-sm outline-none transition-all text-left placeholder:text-outline-variant"
            ...
            <div class="mt-12 relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-4 bg-transparent text-outline font-label-md">
                        أو واصل عبر
                    </span>
                </div>
            </div>
            ...
            <p class="mt-12 text-center font-body-md text-on-surface-variant">
                ...
                <a class="text-secondary font-bold hover:text-primary transition-colors border-b-2 border-secondary/20 hover:border-secondary pb-0.5"
                   href="{{ route('register') }}">
                    انضم إلينا الآن
                </a>
            </p>
        ...
        <!-- Image Section -->
        <div class="lg:col-span-5 relative hidden lg:block overflow-hidden login-image-box group">
    ...
    src="{{ asset('images/auth/login-pets.jpg') }}"

            <div class="absolute inset-0 z-20 flex flex-col justify-end p-12 text-white">
                <h1 class="font-display-lg text-display-md mb-4 leading-tight">
                    مرحباً بك في عالم الأليفين
                </h1>

                <p class="font-body-lg text-emerald-50/80 leading-relaxed">
                    سجل دخولك لتتمكن من الوصول لآخر العروض وخدمات الرعاية المخصصة لحيوانك المفضل.
                </p>
            </div>
