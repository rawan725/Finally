...
<main class="max-w-7xl mx-auto px-6 py-12" dir="rtl">
    ...
    <section class="space-y-6">
        ...
        @forelse($bookings as $booking)
            ...
            <div class="bg-white rounded-[28px] border border-emerald-100 shadow-[0_10px_35px_rgba(27,67,50,0.06)] overflow-hidden">

                <div class="bg-emerald-50/70 px-6 py-5 border-b border-emerald-100 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-sm text-emerald-900/60">
                            تاريخ الطلب: {{ $booking->created_at->format('Y-m-d') }}
                        </p>
                    </div>
                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="rounded-3xl border border-emerald-100 p-5 bg-white text-right">
                        ...
                        <h3 class="font-black text-emerald-900 mb-2">
        ...
        @empty
            ...
            <div class="bg-white rounded-[28px] border border-emerald-100 shadow-[0_10px_35px_rgba(27,67,50,0.06)] p-14 text-center">
